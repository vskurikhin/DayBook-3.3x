...
// Source: github.com/vskurikhin/DayBook-3.3x/auth/v2/internal/server/db (interfaces: Pool)
//
// Generated by this command:
//
//	mockgen -destination=pgx_pool_mock_test.go -package=db github.com/vskurikhin/DayBook-3.3x/auth/v2/internal/server/db Pool
//
