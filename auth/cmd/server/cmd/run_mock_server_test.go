...
// Source: github.com/vskurikhin/DayBook-3.3x/auth/v2/internal/server (interfaces: Server)
//
// Generated by this command:
//
//	mockgen -destination=run_mock_server_test.go -package=cmd github.com/vskurikhin/DayBook-3.3x/auth/v2/internal/server Server
//
