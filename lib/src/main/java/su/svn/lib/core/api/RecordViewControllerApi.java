...
public class RecordViewControllerApi {
     ...
     */
    public okhttp3.Call getAllRecordsCall(@javax.annotation.Nonnull ResourceRecordViewFilter filter, @javax.annotation.Nonnull Pageable pageable, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getAllRecordsValidateBeforeCall(@javax.annotation.Nonnull ResourceRecordViewFilter filter, @javax.annotation.Nonnull Pageable pageable, final ApiCallback _callback) throws ApiException {
