...
import su.svn.lib.auth.auth.Authentication;
import su.svn.lib.auth.auth.HttpBasicAuth;
import su.svn.lib.auth.auth.HttpBearerAuth;
...
public class ApiClient {
    ...
    protected String basePath = "http://localhost:64148/auth/api";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://localhost:64148/auth/api",
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://localhost:64148/auth/api)
     ...
     * @return a {@link su.svn.lib.auth.ApiClient} object
     */
    ...
    */
     ...
     * @throws su.svn.lib.auth.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws su.svn.lib.auth.ApiException If fail to serialize the given object
     */
     ...
     * @throws su.svn.lib.auth.ApiException If fail to read file content from response and write to disk
     ...
     * @throws su.svn.lib.auth.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws su.svn.lib.auth.ApiException If the response has an unsuccessful status code or
     ...
     * @throws su.svn.lib.auth.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws su.svn.lib.auth.ApiException If fails to update the parameters
     */
     ...
     * @throws su.svn.lib.auth.ApiException If fail to serialize the request body object into a string
     */
