...
/**
 * Mapper for converting markdown DTO models
 * and {@link TextRecord} entities.
 * <p>
 * Performs transformation between transport-layer
 * markdown representations and persistence entities.
 * </p>
 */
@Mapper(
...
public interface MarkdownRecordMapper extends TagMapper {
    ...
    ResourceMarkdownRecord toResource(NewMarkdownRecord record);

    @Mapping(target = "userName", ignore = true)
    ResourceMarkdownRecord toResource(UpdateMarkdownRecord record);
