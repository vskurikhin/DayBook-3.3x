...
public interface LinkRecordMapper extends TagMapper {
    ...
    @Mapping(source = "value", target = "link")
    ResourceLinkRecord toResource(TextRecord record);

    @Mapping(target = "id", ignore = true)
    @Mapping(target = "userName", ignore = true)
    @Mapping(target = "refreshAt", ignore = true)
    ResourceLinkRecord toResource(NewLinkRecord record);

    @Mapping(target = "userName", ignore = true)
    ResourceLinkRecord toResource(UpdateLinkRecord record);
    ...
    @Mapping(source = "link", target = "value")
    TextRecord toEntity(ResourceLinkRecord record);
}
